...
func ResetPassword(form *helpers.ResetPasswordForm) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 templ.SafeURL = templ.URL(components.Page(ctx).Path)
		...
		var templ_7745c5c3_Var3 = []any{fmt.Sprintf("input %s", form.GetFieldStatusClass("Password"))}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/reset-password.templ`, Line: 1, Col: 0}
		}
		...
		var templ_7745c5c3_Var5 = []any{fmt.Sprintf("input %s", form.GetFieldStatusClass("ConfirmPassword"))}
