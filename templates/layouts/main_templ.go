...
func Main(contents templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 templ.SafeURL = components.Funcs(ctx).URL("home")
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/layouts/main.templ`, Line: 17, Col: 102}
		}
		...
		templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("home", "Dashboard", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("about", "About", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li><li>")
		...
		templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("contact", "Contact", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li><li>")
		...
		templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("cache", "Cache", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li><li>")
		...
		templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("task", "Task", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if components.Page(ctx).IsAuth {
			...
			templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("logout", "Logout", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li>")
			...
			templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("login", "Login", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li><li>")
			...
			templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("register", "Register", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li><li>")
			...
			templ_7745c5c3_Err = templ.Raw(components.Funcs(ctx).Link("forgot_password", "Forgot password", components.Page(ctx).Path)).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</li>")
		...
		if components.Page(ctx).Title != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/layouts/main.templ`, Line: 71, Col: 54}
			}
...
func search() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(string(components.Funcs(ctx).URL("search")))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/layouts/main.templ`, Line: 94, Col: 59}
		}
